...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title">E-commerce Solution</h2>
                        ...
                        <div class="service-sidebar">
                            ...
                            <div class="service-sidebar__single  wow fadeInUp" data-wow-delay='500ms'>
                                <div class="service-sidebar__contact">
                                    ...
                                    <div class="service-sidebar__contact-image">
                                        <img src="assets/images/resources/ecom.jpg" alt>
                                    </div>
                            ...
                            <div class="service-sidebar__single  wow fadeInUp" data-wow-delay='500ms'>
                                <div class="service-sidebar__contact_bottom">
                                    <h3 class="service-sidebar__contact-title">Ecommerce Development Solutions</h3>
                                    <!-- /.service-sidebar__contact__title -->
                    ...
                    <div class="col-md-12 col-lg-8">
                        <div class="service-details__content">
                            <div class="service-details__single">
                                ...
                                <h3 class="service-details__title wow fadeInUp" data-wow-delay='300ms'>Top Ecommerce
                                    Development Solutions for Your Business</h3><!-- /.service-details__title -->
                                ...
                                <p class="service-details__text wow fadeInUp" data-wow-delay='350ms'>Many businesses
                                    ...
                                    products, and target audience. We analyze performance metrics and refine campaigns
                                    to improve results. This ensures you get the most value from our <b
                                        class="text-bold">managed ecommerce services</b>.
                                </p>
                                <div class="service-details__thumbnail wow fadeInUp" data-wow-delay='300ms'>
                                    <img src="assets/images/resources/ecom.jpg" alt="Conversion Rate Optimization">
                                </div><!-- /.service-details__thumbnail -->
                                <h3 class="service-details__title wow fadeInUp" data-wow-delay='300ms'>Get Professional
                                    Solutions for Your Ecommerce Business.</h3><!-- /.service-details__title -->
                                <p class="service-details__text wow fadeInUp" data-wow-delay='350ms'>We constantly test
                                    and analyze different messaging, creative assets, targeting, and placement to boost
                                    campaign performance. We design <b class="text-bold">professional ecommerce
                                        solutions</b> designed to engage your audience and prompt actions like clicks,
                                    shares, and sales.
                                    <br>
                                    Our <b class="text-bold">ecommerce business campaigns</b> span leading platforms
                                    like Facebook, Instagram, Twitter, LinkedIn, and more to reach potential customers
                                    wherever they are online. We have a proven track record of delivering real ROI
                                    through social media for <b>ecommerce businesses</b> through increased website
                                    traffic, lead generation, and sales.
                                </p>

                                <h3 class="service-details__title wow fadeInUp" data-wow-delay='300ms'>Get Custom
                                    Ecommerce Development Solutions for Your Online Store</h3>
                                <!-- /.service-details__title -->
                                <p class="service-details__text wow fadeInUp" data-wow-delay='350ms'>We test and analyze
                                    different tips and techniques to boost your online store sales. We design <b
                                        class="text-bold">professional ecommerce solutions</b> to engage your audience
                                    and prompt actions like clicks, shares, and sales.
                                    <br>
                                    Our <b class="text-bold">ecommerce business campaigns</b> span leading platforms
                                    like Facebook, Instagram, Twitter, LinkedIn, and more to reach potential customers
                                    wherever they are online. We have a proven track record of delivering real ROI
                                    through social media for <b class="text-bold">ecommerce businesses</b> through
                                    increased website traffic, lead generation, and sales.
                                </p>

                                <h3 class="service-details__title wow fadeInUp" data-wow-delay='300ms'>Get Affordable
                                    Ecommerce Marketing Solutions Right Now</h3><!-- /.service-details__title -->
                                <p class="service-details__text wow fadeInUp" data-wow-delay='350ms'>Our team combines
                                    strategic expertise with cutting-edge tools and technology to drive real social
                                    media results. By getting our <b class="text-bold">ecommerce web design
                                        services</b>, you can dominate your niche and retain customers. It ultimately
                                    grows your business.
                                </p>
