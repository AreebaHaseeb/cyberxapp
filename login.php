...
<head>
    ...
    <!-- ======== Page title ============ -->
    <title>Login || || SEO & Digital Marketing HTML Template</title>
                                ...
                                <form class="login-page__form">
                                    ...
                                    <div class="login-page__checked-box">
                                        ...
                                        <div class="login-page__form-forgot-password">
                                            <a href="login.php" class="login-page__form-forgot-password__item">Forget
                                                Password?</a>
                                        </div>
                                    </div>
                                    <div class="login-page__form-btn-box">
                                        <button type="submit"
                                            class="cyber-btn cyber-btn-base"><span>Login</span></button>
                                    </div>
                                </form>
