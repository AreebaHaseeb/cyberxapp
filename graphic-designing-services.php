...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title">Graphic Designing</h2>
                        ...
                        <div class="service-sidebar">
                            ...
                            <div class="service-sidebar__single  wow fadeInUp" data-wow-delay='500ms'>
                                <div class="service-sidebar__contact">
                                    ...
                                    <div class="service-sidebar__contact-image">
                                        <img src="assets/images/resources/graphic-des.jpg" alt>
                                    </div>
                            ...
                            <div class="service-sidebar__single  wow fadeInUp" data-wow-delay='500ms'>
                                <div class="service-sidebar__contact_bottom">
                                    <h3 class="service-sidebar__contact-title">Graphic Design Services</h3>
                                    <!-- /.service-sidebar__contact__title -->
                                    <div class="service-sidebar__contact-image">
                                        <img src="assets/images/resources/graphic-desig-2.jpg" alt>
                                    </div>
                                    <div class="service-sidebar__contact-angle">
                                        <img src="assets/images/shapes/contact-shape.png" alt>
                                    </div>
                    ...
                    <div class="col-md-12 col-lg-8">
                        <div class="service-details__content">
                            <div class="service-details__single">
                                ...
                                <h3 class="service-details__title wow fadeInUp" data-wow-delay='300ms'>Elevate Your
                                    Brand's Online Presence With Expert Graphic Design Services</h3>
                                ...
                                <div class="service-details__thumbnail wow fadeInUp" data-wow-delay='300ms'>
                                    <img src="assets/images/resources/graphic-des.jpg"
                                        alt="Conversion Rate Optimization">
                                </div><!-- /.service-details__thumbnail -->
                                <h3 class="service-details__title wow fadeInUp" data-wow-delay='300ms'>Our Top Graphic
                                ...
                                <p class="service-details__text wow fadeInUp" data-wow-delay='350ms'>Feel free to step
                                    ...
                                    <br>
                                    We offer various <b class="text-bold">graphic design services</b> covering a wide
                                    range of products, including websites, logos, brochures, business cards, mailers,
                                    posters, and so on. You can turn potential clients into paying customers and upscale
                                    your business with us. Some of our top <b class="text-bold">design and branding
                                        services</b> include:
                                </p>
                                <ul class="list-unstyled service-details__list">
                                    <li> <i class="fa fa-check-circle"></i>Logos and branded elements</li>
                                    <li> <i class="fa fa-check-circle"></i> Social media graphics</li>
                                    <li> <i class="fa fa-check-circle"></i>Email marketing graphics</li>
                                    <li> <i class="fa fa-check-circle"></i>Digital marketing ads</li>
                                </ul>
                                <h3 class="service-details__title wow fadeInUp" data-wow-delay='300ms'>What Sets Our
                                    Design and Branding Services Apart from Others?</h3>
                                <!-- /.service-details__title -->
                                <p class="service-details__text wow fadeInUp" data-wow-delay='350ms'>
                                    As a <b class="text-bold">graphic design company</b>, we offer <b
                                        class="text-bold">quality branding and design services</b> with quick and speedy
                                    turnaround. Being a tech agency, we can manage and design projects while keeping up
                                    the pace with a variety of teams like Facebook, Amazon, and more. Get a quote today
                                    to know what we can bring on the board for your business’s design and branding and
                                    uplift your revenue!
                                </p>
