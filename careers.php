    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <div class="container">
                ...
                <p>Amazing Opportunities Await You!</p>
                </div>
                
            </div>
        </section>
<section class="brerad">
<div class="crystal-breadcrumb"><div class="wrap"><div><p id="breadcrumbs"><span><span><a href="index.php">Home</a></span> / <span class="breadcrumb_last" aria-current="page">CAREERS</span></span></p></div></div></div>
</section>
         ...
         <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="services-detail-main-heading mb-3 text-lg-start">
                        <h2><span class="color-text">CAREERS</span></h2>
                        <p>Connect with Your Audience When They Need You Most</p>
                    </div>
                        <p>
                        More than just a company, Thrive is home to creative, dedicated and driven individuals who work towards a shared goal:developing meaningful relationships and noteworthy results. Come and join a leading digital marketing agency that prioritizes overall organizational health and long-term growth!
                        </p>
                        <div class="form-one__control form-one__control--full">
                        <button type="submit" class="cyber-btn cyber-btn-base ">BE PART OF SOMETHING GREAT</button>
                        </div>
         ...
         <!-- reviews -->
          <section class="carreers-section mb-60">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
            <div class="carreers">
            <div class="threeculture d-flex gap-3 align-items-center">
                <div>
                <div class="feature">
                <img src="./assets/images/icon/positive-work.svg" alt="Positive Work Culture">
                <p>Positive Work Culture</p>
            </div>
        </div>
        <div class="features">
            <div class="d-flex flex-column gap-3">
            <div class="feature">
                <img src="./assets/images/icon/long-term.svg" alt="Long-Term Career Paths">
                <p>Long-Term Career Paths</p>
            </div>
            <div class="feature">
                <img src="./assets/images/icon/leadership.svg" alt="People-Oriented Leadership">
                <p>People-Oriented Leadership</p>
            </div>
            </div>
            </div>
        </div>
        ...
        <div class="info-box">
        <div class="services-detail-main-heading mb-3 text-lg-start">
        <h2>Why crystal Techify?</h2>
        </div>
            <p>Driving Individual and Business Transformations Since 2005</p>
            <p>Thrive Internet Marketing Agency is a recognized leader in the digital marketing realm. For more than 19 years, we have actively built and sustained our commitment to improving the lives of our employees, partner agencies and local communities through our people-centric company programs and services.</p>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="services-detail-main-heading">
                        <h2>Our <span class="color-text">Digital Marketing</span>  Services Speak of Their Own</h2>
                        <p>Connect with Your Audience When They Need You Most</p>
                    </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="detail-text">
                        <p>
                        In the world of digital marketing, SMARTWORK is as useful as a screen door on a submarine.<br> Unlike traditional marketing where you pay big bucks and hope for results, we believe it's not just about getting traffic; it's about getting the right traffic and converting it into revenue.
                        </p>
                        <p>
                        We know just one language - talking click-through rates, conversion rates, bounce rates – data that tells you exactly what's working and what's not. <br>  We track, analyze, and optimize every campaign, ensuring that every dollar you spend is maximized.
                        </p>
...
<div class="container">
    <div class="row">
        <div class="com-md-12">
        <div class="services-detail-main-heading">
                        <h2>Why Are <span class="color-text">Digital Marketing</span>  Services a Plus for Any Business?</h2>
    ...
    <div class="row mb-60">
        <div class="col-md-6">
         <div class="engage-text">
            <p>
            In today's fast-paced digital world, standing out from the crowd is not a . Traditional marketing methods just don't cut it anymore.
            <br><br> This is where digital marketing services come in, offering a powerful, cost-effective way to boost your brand and hit your business targets.
            </p>
            <p>
 ...
 <section class="faq-section mb-60">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
            <div class="services-detail-main-heading">
                        <h2><span class="color-text">Digital Marketing</span>  Services FAQs</h2>
