...
?>
    ...
    <div class="page-wrapper">
        ...
        <nav class="navbar navbar-info sticky-top  flex-md-nowrap p-10" style="background-color: #0D6EFD;">
            <a class="navbar-brand col-sm-3 col-md-2 mr-0 pl-2" href=""
                style="color:white; padding-left:20px"><b>Dashboard</b></a>
            <ul class="navbar-nav px-3">
                <li class="nav-item text-nowrap">
                    <a class="nav-link" style="color: white;" href="logout.php">Hi,
                        <?php echo ucwords($_SESSION['NAME']); ?> Log out</a>
                </li>
                </ull>
        </nav>
        <div class="container-fluid">
            <div class="row">
                <nav class="col-md-2 d-none d-md-block  sidebar" style="height: 569px; background-color: #0D6EFD;">
    ...
    if ($result->num_rows > 0) {
       ...
       echo "<h2>No record found!</h2>";
                                ...
                                <form class="login-page__form">
                                    ...
                                    <div class="login-page__checked-box">
                                        ...
                                        <div class="login-page__form-forgot-password">
                                            <a href="login.php" class="login-page__form-forgot-password__item">Forget Password?</a>
                                        </div>
                                    </div>
                                    <div class="login-page__form-btn-box">
                                        <button type="submit" class="cyber-btn cyber-btn-base"><span>Login</span></button>
                                    </div>
                                </form>
                        ...
                        <div class="col-lg-6 wow fadeInUp animated" data-wow-delay="400ms">
                            <div class="login-page__wrap register-page__wrap">
                                ...
                                <form class="login-page__form">
                                    ...
                                    <div class="login-page__form-btn-box">
                                        <button type="submit" class="cyber-btn cyber-btn-base">
                                            <span>Register</span>
                                        </button>
                                    </div>
                                </form>
        ...
        <footer class="main-footer @@extraClassName">
            <div class="main-footer__bg" style="background-image: url(assets/images/backgrounds/footer-bg-1-1.png);">
            </div>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="footer-widget">
                                ...
                                <div class="main-footer__inner-social">
                                    ...
                                    <a href="https://www.linkedin.com/"><i class="icon-linkedin"
                                    ...
                                    <a href="https://youtube.com/"> <i class="icon-youtube" aria-hidden="true"></i>
                            ...
                            <div class="footer-widget">
                                <div class="footer-widget--links">
                                    ...
                                    <ul class="list-unstyled footer-widget__links">
                                        ...
                                        <li class="footer-widget__links__item"><a
                                                href="mobile-app-development-services.php">Mobile App Development</a>
                                        </li>
                                        <li class="footer-widget__links__item"><a
                                                href="graphic-designing-services.php">Graphics Designing</a></li>
                            ...
                            <div class="footer-widget">
                                <div class="footer-widget--about">
                                    ...
                                    <ul class="list-unstyled footer-widget__info">
                                        <li class="footer-widget__info__item"> <span class="footer-widget__text"><b
                                                    style="color: #0D6EFD;">USA (Head Office):</b> <br>Suit: 1276, 767
                                                Broadway, Manhattan, NY 10003 U.S</span></li>
                                        <li class="footer-widget__info__item"> <span class="footer-widget__text"><b
                                                    style="color: #0D6EFD;">Branch:</b> <br>PO BOX 3323 Dublin, OH
                                                43016. U.S</span></li>
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="mobile-nav__social">
                ...
                <a href="https://twitter.com/"><i class="icon-twitter" aria-hidden="true"></i><span
                        class="sr-only">Twitter</span></a>
                <a href="https://pinterest.com/"> <i class="icon-pinterest" aria-hidden="true"></i> <span
                        class="sr-only">Pinterest</span></a>
                <a href="https://instagram.com/"> <i class="icon-instagram" aria-hidden="true"></i> <span
