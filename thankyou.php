...
<head>
    ...
    <!-- ========== Favicon Icon ========== -->
    <link rel="canonical" href="https://cyberxapp.com/thankyou" />
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title">Thank You</h2>
        ...
        <div class="container">
            <div class=content>
                <div class="wrapper-1">
                    <div class="wrapper-2">
                        <h1>Thank you !</h1>
                        <p>Thankyou so much for <b>getting in touch </b> with us. </p>
                        <p>You means a alot and we promise to keep inspiring you like always.</p>
