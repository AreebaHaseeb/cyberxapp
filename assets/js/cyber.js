...
(function ($) {
  ...
  $(document).ready(function() {
    ...
    function checkScreenSize() {
        ...
        // Check screen size and add/remove classes accordingly
        if (screenWidth < 768) {
            $('.main-menu__list').removeClass('cyber-sub-menu');
        } else {
            $('#myElement').removeClass('cyber-mega-menu');
        }
    }
  ...
  window.addEventListener('scroll', function() {
    ...
    // Set the "active" class based on scroll position
  ...
  // Date Picker
  if ($(".cyber-datepicker").length) {
    $(".cyber-datepicker").each(function () {
      $(this).datepicker();
    });
  }
  ...
  //   a.forEach((item) => {
  //     item.addEventListener("mouseo-servicesver", () => {
  ...
  //accrodion
  if ($(".cyber-accrodion").length) {
    var accrodionGrp = $(".cyber-accrodion");
  ...
  function thmOwlInit() {
    // owl slider
    let cyberowlCarousel = $(".cyber-owl__carousel");
    if (cyberowlCarousel.length) {
      cyberowlCarousel.each(function () {
        let elm = $(this);
    ...
    let cyberowlCarouselNav = $(".cyber-owl__carousel--custom-nav");
    if (cyberowlCarouselNav.length) {
      cyberowlCarouselNav.each(function () {
        let elm = $(this);
  ...
  function thmTinyInit() {
    // tiny slider
    const tinyElm = document.querySelectorAll(".cyber-tiny__slider");
  ...
  //Strech Column
  function cyber_stretch() {
    var i = $(window).width();
    $(".row .cyber-stretch-element-inside-column").each(function () {
      var $this = $(this),
